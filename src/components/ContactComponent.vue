...
<template>
  <header class="flex flex-wrap flex-col items-center justify-center gap-10 py-12 px-8 sm:px-8 md:px-12 lg:px-20">
      ...
      <form ref="form" @submit.prevent="handleSubmit">
        <div class="flex items-start justify-between flex-wrap gap-4">
          ...
          <div class="name lg:w-[300px] md:w-[300px] sm:w-[300px] w-full">
            ...
            <input class="text-slate-700 mt-2 py-3 pl-2 w-full bg-[#f5f6f7] focus:bg-[#eff1f4] outline-none" type="email"
        ...
        <button type="submit"
          class="text-slate-700 inconsolata flex items-center justify-center w-1/2 px-6 py-3 border border-slate-700 mt-4 bg-[#eff1f4] hover:bg-slate-700 hover:text-slate-50 transition-all duration-300">
