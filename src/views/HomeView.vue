...
<template>
  <header class="flex flex-wrap gap-y-12 mt-20 justify-between px-12 sm:px-8 md:px-12 lg:px-20 mb-5 items-center">
    ...
    <div data-aos="fade-up" data-aos-delay="100">
      <div class="flex gap-x-6 inconsolata" id="filters">
  ...
  <section class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-12 sm:px-8 md:px-12 lg:px-20 projects w-full" data-aos="fade-up" data-aos-delay="200">
